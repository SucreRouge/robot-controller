...
xlabel("Data Point")
ylabel("Vx")
ax5.plot(array(range(1, l+1)), yd[:, 0], color = 'r', label = "Vx Data")
ax5.plot(array(range(1, l+1)), y[:, 0], color = 'b', label = "Vx tested output")
ax5.legend()
savefig("q5_5.png")
...
xlabel("Data Point")
ylabel("Vy")
ax6.plot(array(range(1, l+1)), yd[:, 1], color = 'r', label = "Vy Data")
ax6.plot(array(range(1, l+1)), y[:, 1], color = 'b', label = "Vy tested output")
ax6.legend()
savefig("q5_6.png")
